...
<c:if test="${who eq '2' }">
<li class="like"><a onclick="updateStock(<%=dto.getProduct_seq()%>)">입고<i class="lni lni-heart"></i></a></li>
<li class="like"><a onclick="changeStock(<%=dto.getProduct_seq()%>)">수정<i class="lni lni-heart"></i></a></li>
</c:if>
</ul>
</div>
</div>
